...
public class Assets {
	...
	public static void init() {
		...
		player1  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 0, width, heightBig);
		player2  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 1, width, heightBig);
		player3  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 2, width, heightBig);
		player4  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 3, width, heightBig);
		player5  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 4, width, heightBig);
		player6  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 5, width, heightBig);
		player7  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 6, width, heightBig);
		player8  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 7, width, heightBig);
		player9  = sheet.crop(width *  1, heightBig * 0 + newPlayer * 8, width, heightBig);
		player10 = sheet.crop(width *  1, heightBig * 0 + newPlayer * 9, width, heightBig);
